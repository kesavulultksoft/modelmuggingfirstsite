...
function Calendar({
  ...
  const startMonth =
    startMonthProp ?? (dropdownLike ? new Date(year - 120, 0, 1) : undefined)
  const endMonth = endMonthProp ?? (dropdownLike ? new Date(year + 10, 11, 1) : undefined)
...
function CalendarDayButton({
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      data-day={formatUsDate(day.date)}
